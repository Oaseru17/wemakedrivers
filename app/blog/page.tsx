...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Driving tips, driving test preparation advice, and North London driving guides. Expert insights from DVSA-approved instructors to help you pass your driving test first time.',
