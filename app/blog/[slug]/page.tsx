...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://wemakedrivers.co.uk/blog/${post.slug}` },
    openGraph: {
      type: 'article',
      title: post.title,
      description: post.excerpt,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-5">
                <p>
                  Learning to drive in North London is a unique experience that comes with its own set of challenges and rewards.
                  ...
                  for learner drivers across North London.
                </p>
                <p>
                ...
                <p>
                  ...
                  North London junctions, we ensure you gain the experience needed to drive safely and confidently in any
                  environment.
                </p>
                <p>
                  ...
                  WeMake Drivers is the smart choice for anyone learning to drive in North London.
                </p>
              </div>
            </div>
