...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wemakedrivers.co.uk' },
}
...
const FEATURE_ICONS = [
  <Calendar key="cal" size={32} className="text-secondary" />,
  <Shield key="shield" size={32} className="text-secondary" />,
  <Users key="users" size={32} className="text-secondary" />,
  <BookOpen key="book" size={32} className="text-secondary" />,
  <Target key="target" size={32} className="text-secondary" />,
  <Map key="map" size={32} className="text-secondary" />,
]
    ...
    <main>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-500 mt-12 text-lg">
            Not sure which course is right for you? <Link href="/contact-us" className="text-secondary font-semibold hover:underline">Let's figure it out together.</Link>
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-500 mt-12 text-lg">
            That could be you. <Link href="/contact-us" className="text-secondary font-semibold hover:underline">Start your journey today.</Link>
          </p>
        </div>
      </section>

      {/* Section 8 — Instructor Bio */}
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4">
      ...
      {/* Section 9 — North London Coverage */}
